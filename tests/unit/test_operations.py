"""
Tests for src/calculator/operations.py
...
import pytest
from your_module import add # Assuming the functions are in 'your_module.py'
...
import pytest
from your_module_name import multiply # Assuming the function is in 'your_module_name.py'
...
import pytest
from .your_module_name import divide # Assuming 'your_module_name' is the name of the file
